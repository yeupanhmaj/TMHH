                    ...
                    <div className={"addItemWrapper listItemWrapper"}  >
                        <div style={{ display: 'table' }}>
                            <div className={'listItemHeader'}  >
                                <div style={{ width: 40, borderRight: '1px solid #ddd', padding: '5px 10px' }}>STT</div>
                                <div style={{ width: 300, borderRight: '1px solid #ddd', padding: '5px 10px' }}>Tên Sản Phẩm</div>
                                <div style={{width:80, borderRight: '1px solid #ddd', padding: '5px 10px' }}>Đơn vị</div>
                                <div style={{width:80, borderRight: '1px solid #ddd', padding: '5px 10px' }}>Số lượng</div>
                            ...
                            {items && items.map((item, index) => {
                                return (
                                    <div key={`listItemRow` + index.toString()} className={'listItemRow'}  >
                                        <div style={{ minWidth: 40, borderRight: '1px solid #ddd', padding: '5px 10px' }}>{index + 1}</div>
                                        <div style={{ width: 300, borderRight: '1px solid #ddd', padding: '5px 10px' }}>{item.itemName}</div>
                                        <div className="noWrap" style={{width:80, borderRight: '1px solid #ddd', padding: '5px 10px' }}>{item.itemUnit}</div>
                                        <div className="noWrap" style={{ width: 80, borderRight: '1px solid #ddd', padding: '5px 10px' }}>{item.amount}</div>
                                        ...
                                        <div className="noWrap" style={{ minWidth: 100, textAlign: 'center', flex: 2, padding: '5px 10px', borderRight: '1px solid #ddd' }}>
                                            {(items[index] !==undefined && items[index]['itemPrice'] !==undefined) ? this.formatNumber((items[index]['itemPrice'].toString().replace(/\./g, '')) * items[index]['amount']) : 0}
                                        </div>
