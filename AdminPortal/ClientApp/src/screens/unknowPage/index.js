...
class UnkowPage extends React.Component  {
  render() {
    return (
      <div className="pagenotfoundwrappers">
        <svg className="svgfortemp" width="380px" height="500px" viewBox="0 0 837 1045" >
        ...
        <div className="message-box">
          ...
          <div className="buttons-con">
            <div className="action-link-wrap">
              <div onClick={() => { this.props.history.goBack();}} className="link-button link-back-button">Go Back</div>
              <div onClick={() => { this.props.history.push('./') }} className="link-button">Go to Home Page</div>
            </div>
          </div>
        </div>
      </div>
...
export default withRouter(UnkowPage);
