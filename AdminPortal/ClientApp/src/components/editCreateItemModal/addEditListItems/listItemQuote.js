                    ...
                    <div className={"addItemWrapper listItemWrapper"}  >
                        <div style={{ display: 'table' }}>
                            <div className={'listItemHeader'}  >
                                ...
                                {(checkWarranty || !itemDef.isNotEdited) && <div style={{ minWidth: 100, flex: 1, borderRight: '1px solid #ddd', padding: '5px 10px' }}>Bảo hành (tháng)</div>}
                                ...
                                return (
                                    <div key={`listItemRow` + index.toString()} className={'listItemRow'}  >
                                        ...
                                        {itemDef.isNotEdited ===true ?
                                            ...
                                            :
                                            <div className="noWrap" style={{ minWidth: 100, flex: 1, padding: '5px 10px', borderRight: '1px solid #ddd' }}>
                                                <input style={{
                                                    textAlign: 'center',
                                                    ...
                                                    value={items[index]['warrantyYears'] || ''}
                                                    onChange={(event) => {
                                                        this.dataChange('warrantyYears', event.target.value, index)
                                                    }}
                                                />
                                            </div>
                                        }
                                        ...
                                        {itemDef.isNotEdited ===true ?
                                            ...
                                            <div className="noWrap" style={{ minWidth: 100, flex: 2, padding: '5px 10px', borderRight: '1px solid #ddd' }}>
                                                <input style={{
                                                    ...
                                                    value={items[index]['itemPrice'] ? this.formatNumber(items[index]['itemPrice']) : ''}
                                                    onChange={(event) => {
                                                        this.amountChange('itemPrice', event.target.value, index)
                                                    }}
                                                />
                                            </div>
                                        }
                                        ...
                                        {itemDef.isNotEdited ===true ?
                                            ...
                                            :
                                            <div style={{ flex: 5, minWidth: 200, padding: '5px 10px' }}>
                                                <textarea style={{
                                                    fontSize: 12, fontFamily: 'roboto', fontWeight: 400,
                                                    boxShadow: '0 1px 5px rgba(0, 0, 0, 0.15)',
                                                    height: 70, width: '100%'
                                                }}
                                                    value={items[index]['quoteNote'] || ''}
                                                    onChange={(event) => {
                                                        this.dataChange('quoteNote', event.target.value, index)
                                                    }}
                                                />
                                            </div>
                                        }
